    ...
    <div className="flex min-h-screen bg-white font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#1E6CF6] via-[#1E6CF6] to-[#00D4FF] flex-col items-center justify-center p-12 text-white">
        <div className="max-w-md text-center">
          ...
          <h1 className="text-4xl font-extrabold mb-4 tracking-tight">Dashboard DANA TEPAT</h1>
          <p className="text-lg text-blue-50/90 mb-8 leading-relaxed">
            Platform administrasi berbasis blockchain untuk transparansi dan akuntabilitas program bantuan sosial
          </p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 lg:p-24 bg-slate-50">
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex items-center gap-3 mb-8 justify-center lg:justify-start">
            ...
            <span className="text-2xl font-bold text-slate-800 tracking-tight">DANA TEPAT</span>
          </div>

          <div className="space-y-2 mb-8 text-center lg:text-left">
            <h2 className="text-2xl font-bold text-slate-900">Masuk ke Dashboard DANA TEPAT</h2>
            <p className="text-slate-500 text-sm">Kelola program bantuan sosial dengan transparansi blockchain</p>
          </div>
          ...
          <div className="bg-emerald-50/50 border border-emerald-100 rounded-xl p-3 flex items-start gap-3 mb-8">
            ...
            <div className="space-y-0.5">
              <p className="text-sm font-semibold text-emerald-900">Akses Aman</p>
              <p className="text-xs text-emerald-700 leading-relaxed">Dashboard ini dilindungi oleh sistem blockchain dan enkripsi OAuth 2.0</p>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Checkbox id="remember" className="rounded-md border-slate-300 data-[state=checked]:bg-[#1E6CF6] data-[state=checked]:border-[#1E6CF6]" />
                <Label htmlFor="remember" className="text-sm text-slate-600 font-medium cursor-pointer">Ingat saya</Label>
              </div>
              <Link to="#" className="text-sm font-semibold text-[#1E6CF6] hover:underline">Lupa kata sandi?</Link>
            </div>

            <Button type="submit" className="w-full h-12 bg-[#1E6CF6] hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-500/20 transition-all active:scale-[0.98]">
              Masuk Sekarang
            </Button>

            <p className="text-center text-slate-500 text-sm">
              Belum punya akun? <Link to="#" className="font-semibold text-[#1E6CF6] hover:underline">Daftar</Link>
            </p>
          </form>
          ...
          <div className="mt-12 pt-8 border-t border-slate-200 flex flex-wrap items-center justify-center gap-6 text-slate-400">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] uppercase tracking-wider font-bold">Hyperledger Fabric</span>
            </div>
            <div className="flex items-center gap-2">
              <QrCode className="w-4 h-4" />
              <span className="text-[10px] uppercase tracking-wider font-bold">QRIS Integration</span>
            </div>
            <div className="flex items-center gap-2">
              <BarChart3 className="w-4 h-4" />
              <span className="text-[10px] uppercase tracking-wider font-bold">Real-time Analytics</span>
            </div>
          </div>
        </div>
      </div>
