      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-slate-500 text-sm font-medium">
              Kelola akses pengguna dan hak akses role dalam sistem
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, idx) => (
            <div
              key={idx}
              className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group flex items-center justify-between"
            >
        ...
        <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              className="text-slate-500 font-bold text-xs h-10 px-4 rounded-xl hover:bg-slate-50 border-slate-200 gap-2"
            >
              ...
              <tbody className="divide-y divide-slate-100">
                {userData.map((user, idx) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-5 text-sm font-semibold text-slate-600 text-center">
                      {user.lastLogin}
                    </td>
                    <td className="px-6 py-5">
                      <div className="flex items-center justify-center gap-2">
          ...
          <div className="p-6 border-t border-slate-100 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="ghost"
                size="sm"
                className="h-9 w-9 p-0 text-slate-400 hover:bg-slate-50"
              >
