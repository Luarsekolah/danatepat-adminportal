    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-slate-500 text-sm font-medium">Pantau aktivitas platform bantuan sosial secara real-time</p>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-100 rounded-2xl p-4 flex items-center justify-between group cursor-pointer hover:bg-amber-100/50 transition-colors">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-xs font-bold text-amber-800 uppercase tracking-wider">Perhatian</p>
              <p className="text-sm font-semibold text-amber-700">2 Settlement menunggu verifikasi</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-3 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-lg font-extrabold text-slate-900">Aktivitas Transaksi Harian</h3>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={transactionData}>
                  ...
                  <Line 
                    ...
                    stroke="#1E6CF6" 
                    strokeWidth={4} 
                    dot={{fill: '#1E6CF6', strokeWidth: 2, r: 6, stroke: '#fff'}} 
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-lg font-extrabold text-slate-900">Distribusi Token per Kategori</h3>
              <button className="p-2 text-slate-400 hover:bg-slate-50 rounded-xl">
                <MoreHorizontal className="w-5 h-5" />
              </button>
            </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-100 flex items-center justify-between">
            <h3 className="text-lg font-extrabold text-slate-900">Aktivitas Terbaru</h3>
            <Button variant="ghost" className="text-[#1E6CF6] font-bold text-sm hover:bg-blue-50">
              Lihat Semua
            </Button>
          </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50/50">
                  ...
                  <th className="px-6 py-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Jenis</th>
                  <th className="px-6 py-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Status</th>
                  <th className="px-6 py-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Hash Blockchain</th>
              ...
              <tbody className="divide-y divide-slate-100">
                {recentActivities.map((activity, idx) => (
                  <tr key={idx} className="hover:bg-slate-50/30 transition-colors">
                    <td className="px-6 py-4 text-sm font-semibold text-slate-600">{activity.waktu}</td>
                    <td className="px-6 py-4 text-sm font-bold text-slate-900">{activity.jenis}</td>
                    <td className="px-6 py-4">
                      <span className={cn("px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider", activity.color)}>
                        {activity.status}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm font-mono text-slate-400">{activity.hash}</td>
                    <td className="px-6 py-4">
